...
| | |
|---|---|
| `main` | `d26f37a` (#111 merged) |
| declared version | **0.29.0** — released by #112, carrying #102 through #111 |
| default suite (`pytest -q`) | **1764 passing**, under 2 minutes — `tests` plus `quality_tests/fast` |
