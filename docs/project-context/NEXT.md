...
| | |
|---|---|
| `main` | 0.37.0 released by the release PR (before it #319) |
| declared version | **0.37.0** — carrying #319 |
| default suite (`pytest -q`) | **2980 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
