...
| | |
|---|---|
| `main` | 0.34.1 released by the release PR (before it #300) |
| declared version | **0.34.1** — carrying #300 |
| default suite (`pytest -q`) | **2849 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
