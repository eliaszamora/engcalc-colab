...
| | |
|---|---|
| `main` | 0.34.0 released by the release PR (before it #294) |
| declared version | **0.34.0** — carrying #294 |
| default suite (`pytest -q`) | **2845 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
