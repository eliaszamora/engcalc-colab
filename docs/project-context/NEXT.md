...
| | |
|---|---|
| `main` | 0.38.0 released by the release PR (before it #322, #323) |
| declared version | **0.38.0** — carrying #322 and #323 |
| default suite (`pytest -q`) | **2988 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
