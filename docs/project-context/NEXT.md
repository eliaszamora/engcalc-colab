...
| | |
|---|---|
| `main` | 0.33.0 released by the release PR (before it #270) |
| declared version | **0.33.0** — carrying #270 |
| default suite (`pytest -q`) | **2738 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
