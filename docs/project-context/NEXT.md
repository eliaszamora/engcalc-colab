...
| | |
|---|---|
| `main` | 0.34.2 released by the release PR (before it #303, #304) |
| declared version | **0.34.2** — carrying #303 and #304 |
| default suite (`pytest -q`) | **2867 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
