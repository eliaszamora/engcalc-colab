...
| | |
|---|---|
| `main` | 0.39.0 released by the release PR (before it #326-#334) |
| declared version | **0.39.0** — carrying #326-#334 |
| default suite (`pytest -q`) | **3117 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
