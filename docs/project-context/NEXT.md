...
| | |
|---|---|
| `main` | 0.41.0 released by #344 (`e879667`, before it #342, #343), closed |
| declared version | **0.41.0** — carrying #342 and #343 |
| default suite (`pytest -q`) | **3192 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
