...
| | |
|---|---|
| `main` | 0.33.3 released by the release PR (before it #279) |
| declared version | **0.33.3** — carrying #279 |
| default suite (`pytest -q`) | **2760 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
