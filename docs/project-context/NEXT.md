...
| | |
|---|---|
| `main` | #237 merged, 0.31.15 (before it `9343152`, #236) |
| declared version | **0.31.15** — released by #237, carrying #233, #235 and #236 |
| default suite (`pytest -q`) | **2545 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
