...
| | |
|---|---|
| `main` | `caf9f4f` (#113 merged) |
| declared version | **0.29.1** — released by #114, carrying the #113 correction |
| default suite (`pytest -q`) | **1771 passing**, under 2 minutes — `tests` plus `quality_tests/fast` |
