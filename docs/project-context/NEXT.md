...
| | |
|---|---|
| `main` | 0.32.3 released by the release PR (before it #266 and #267) |
| declared version | **0.32.3** — carrying #266 and #267 |
| default suite (`pytest -q`) | **2723 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
