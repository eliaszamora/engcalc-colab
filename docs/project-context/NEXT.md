...
| | |
|---|---|
| `main` | 0.36.0 released by the release PR (before it #316) |
| declared version | **0.36.0** — carrying #316 |
| default suite (`pytest -q`) | **2959 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
