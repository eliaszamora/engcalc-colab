...
| | |
|---|---|
| `main` | 0.33.2 released by the release PR (before it #276) |
| declared version | **0.33.2** — carrying #276 |
| default suite (`pytest -q`) | **2745 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
