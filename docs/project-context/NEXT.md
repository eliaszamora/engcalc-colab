...
| | |
|---|---|
| `main` | 0.33.4 released by the release PR (before it #282) |
| declared version | **0.33.4** — carrying #282 |
| default suite (`pytest -q`) | **2772 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
