...
| | |
|---|---|
| `main` | 0.40.0 released by the release PR (before it #336-#338) |
| declared version | **0.40.0** — carrying #336, #337 and #338 |
| default suite (`pytest -q`) | **3119 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
