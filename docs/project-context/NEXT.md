...
| | |
|---|---|
| `main` | 0.34.3 released by the release PR (before it #307) |
| declared version | **0.34.3** — carrying #307 |
| default suite (`pytest -q`) | **2874 passing**, about 3 minutes — `tests` plus `quality_tests/fast` |
