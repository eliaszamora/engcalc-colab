...
def test_project_metadata_version_is_0_31_6():
...
def test_readme_release_version_is_0_31_6():
    ...
    assert "Current version: **0.31.11**." in readme
    assert readme.rstrip().endswith("Version: `0.31.11`.")
